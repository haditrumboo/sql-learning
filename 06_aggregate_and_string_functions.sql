...
-- SELECT MIN(salary) AS MIN_SLARAY , MAX(SALARY) AS MAX_SALARY FROM users;
-- SELECT SUM(salary) AS PAY_ROLE , AVG(SALARY) AS AVG_PAY_ROLE FROM users;
-- SELECT gender , AVG(salary) AS AVG_PAY_ROLE FROM users GROUP BY gender;
